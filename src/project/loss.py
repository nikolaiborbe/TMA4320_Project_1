...
def data_loss(
    ...
    T_model = forward(nn_params, x,y,t, cfg)
    data_loss_val = jnp.mean((T_true - T_model)**2)
...
def ic_loss(
    ...
    T_model = forward(nn_params, x,y,0, cfg)
    ic_loss_val = jnp.mean((cfg.T_outside - T_model)**2)
